...
public class VehicleDrive : MonoBehaviour {
	...
	public Transform centerOfCarMass;
    ...
    void Start()
    {
        ...
        myRigidbody.centerOfMass = centerOfCarMass.transform.position;
    }
    ...
    {
        return wheels[n].gameObject.GetComponentInChildren<WheelCollider>();
    }
}
